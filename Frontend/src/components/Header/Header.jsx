        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center mb-3 xl:w-96 ">
            ...
            <button onClick={handleSearch}
              className="uppercase relative z-[2] rounded-r border-2 border-primary px-6 py-2 text-xs font-medium  text-primary text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 hover:text-black focus:outline-none focus:ring-0 bg-black"
              type="button"
              id="button-addon3"
            >
              Search
          ...
          <div className="flex items-center gap-4">
            {token && user ? (
              <div className="flex items-center justify-between">
                ...
                <div className="p-5 hover:text-primaryColor" onClick={chatPass}>
                  <MarkUnreadChatAltSharpIcon />
                </div>
                {role === 'doctor' && (
                  <div className="relative">
                    <MdNotificationsActive className="w-6 h-6 hover:text-primaryColor" onClick={toggleDropdown} />
              ...
              <Link to="/login">
                <button className="bg-primaryColor hover:shadow-lg hover:scale-105 transition-all duration-500 ease-out py-4 px-7 text-white font-[600] h-[35px] flex items-center justify-center rounded-[50px]">
                  Login
                </button>
              </Link>
            )}
