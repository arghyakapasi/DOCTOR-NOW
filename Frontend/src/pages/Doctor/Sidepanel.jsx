...
const Sidepanel = ({ doctorId, ticketPrice, timeSlots }) => {
    ...
    return (
        <div className='shadow-panelShadow p-3 lg:p-5 rounded-md h-80'>
            ...
            <button onClick={bookingHandler} className='btn hover:shadow-lg hover:scale-105 transition-all duration-500 ease-out px-2 w-full rounded-md' disabled={!selectedTimeSlot}>
                Book appointment
            </button>
        </div>
    );
