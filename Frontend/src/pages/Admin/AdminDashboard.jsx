...
const AdminDashboard = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <h1 className="text-4xl font-bold bg-gradient-to-r from-orange-400 to-red-500 text-white shadow-lg rounded-2xl px-6 py-3 tracking-wide">
        🖥️ Admin Dashboard
      </h1>
        ...
        <div className="space-x-4 flex items-center">
          ...
          <button
            ...
            className="px-4 py-2 rounded-md text-lg font-semibold border border-solid border-gray-500 focus:outline-none flex items-center bg-red-500 text-white hover:shadow-lg hover:scale-105 transition-all duration-500 ease-out"
          >
            Logout
          </button>
        </div>
