...
const SpecialistManagement = ({ specialists }) => {
  ...
  const currentSpecialists = updatedUsers ? updatedUsers.slice(indexOfFirstSpecialist, indexOfLastSpecialist) : [];
  const totalPages = updatedUsers ? Math.ceil(updatedUsers.length / specialistsPerPage) : 1;
                ...
                {currentSpecialists.length > 0 ? (
                  currentSpecialists.map((specialist, index) => (
                    ...
                    >
                      ...
                      >
                        {indexOfFirstSpecialist + index + 1}
                      </th>
                      ...
                      {specialist.specialization && specialist.specialization.length > 0 ? (
                        <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        <button onClick={() => approveDoc(specialist._id)} 
                      ...
                      <td className="px-6 py-4">
                        <button onClick={() => handleBlock(specialist._id)} 
